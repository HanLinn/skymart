...
urlpatterns = [
    ...
    path('SD/<int:id>/ui/<str:mode>/',views.set_sales_ui,name='set_sales_ui'),
    path('SD/<int:id>/lines/',views.salesorderlines,name='salesorderlines'),
    ...
    path('invoice/<int:id>',views.SalesInvoice,name='invoice'),
